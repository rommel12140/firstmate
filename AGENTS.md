...
Resolve every ship task's concrete delivery mode, yolo posture, and verified landing place at intake, and pass all three explicitly to the brief, the spawn, and any scout promotion, which all refuse to guess.
