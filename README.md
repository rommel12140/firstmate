...
Codex and OpenCode are also verified and supported as primary harnesses; Codex uses its Stop-owned native queue adapter, and OpenCode uses a TUI plugin, so both carry more harness-specific supervision tradeoffs than the three co-primaries.
