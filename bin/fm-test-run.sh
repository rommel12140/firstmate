...
family_for_basename() {
  case "$1" in
    ...
    fm-operational-input.test.sh|fm-pi-primary-types.test.sh|fm-pi-status.test.sh|\
    fm-safety-surface-check.test.sh|\
    fm-harness-adapter-references.test.sh|\
    fm-send-popup-settle.test.sh|fm-send-settle.test.sh|\
    fm-subagent-pretool-check.test.sh|\
    fm-supervision-instructions.test.sh|fm-task-delivery.test.sh|\
    fm-tmux-submit-busy.test.sh|fm-trace-context-lib.test.sh|\
    fm-transition-lib.test.sh|fm-workflow-branch-triggers.test.sh|\
    ...
    fm-codex-stop-live-e2e.test.sh|fm-codex-continuity-live-e2e.test.sh|fm-grok-continuity-live-e2e.test.sh|\
    ...
    fm-claude-stop-autoarm.test.sh|fm-codex-stop.test.sh|fm-codex-stop-observer.test.sh|fm-cursor-harness.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-quota-choose.sh)
      printf '%s\n' "__script__:fm-quota-choose.test.sh"
      ;;
    .pi/extensions/fm-primary-status.ts|.pi/extensions/lib/fm-quota-status.ts|tests/fm-pi-status.test.mjs)
      printf '%s\n' __script__:fm-pi-status.test.sh
