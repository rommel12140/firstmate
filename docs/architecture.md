...
The spawn re-reads the project clone's own origin and refuses a recorded landing place the repository contradicts, so the intake pre-answer cannot reach a worker already wrong.
