...
test_relaunch_serializes_concurrent_durable_metadata_publication() {
  ...
  control_pid=$!
  # This waits for setup, not a relaunch latency guarantee. The preceding real
  # git and publication work can exceed two seconds on stock macOS Bash.
  # Keep a bounded readiness wait before asserting the concurrent lock behavior.
